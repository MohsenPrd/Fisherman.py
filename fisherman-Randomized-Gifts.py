...
giftList= ['fishing rod', 'fishing boat', 'fishing hat', 'fishing boots']
randGift= random.choice(giftList)
...
if buy =='yes':
    ...
    if money >= 300:
        ...
        print(f'\n(You): I need {kilosNeed}. here is your money ${money}. and this is your gift! a new {randGift}!!!')
